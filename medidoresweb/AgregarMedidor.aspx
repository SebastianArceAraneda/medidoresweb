<%@ Page Title="" Language="C#" MasterPageFile="~/PrincipalMaster.Master" AutoEventWireup="true" CodeBehind="AgregarMedidor.aspx.cs" Inherits="medidoresweb.AgregarMedidor" %>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="numeromedidor"><b> Ingrese numero de Medidor: </b></label>
                        <asp:TextBox ID="numeromedidor" CssClass="form-control" runat="server"></asp:TextBox>
                    </div>
                    <div class="form-group">
